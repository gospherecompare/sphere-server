    ...
    if (Array.isArray(variants) && variants.length) {
      for (const v of variants) {
        try {
          ...
          await client.query(
            `INSERT INTO product_variants (product_id, variant_key, attributes, base_price) VALUES ($1,$2,$3,$4) ON CONFLICT (product_id, variant_key) DO UPDATE SET attributes = COALESCE(EXCLUDED.attributes, product_variants.attributes), base_price = COALESCE(EXCLUDED.base_price, product_variants.base_price)`,
